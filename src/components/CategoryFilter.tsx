  ...
  return (
    <div className="bg-white py-3 shadow-sm">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-nowrap overflow-x-auto pb-2 gap-2 -mx-2 px-2">
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center min-w-[70px] p-1.5 rounded-lg transition-colors ${
              ...
              >
                <div className="w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center mb-1">
                  <CategoryIcon size={14} className={selectedCategory === category.id ? "text-pet-blue" : "text-gray-500"} />
                </div>
