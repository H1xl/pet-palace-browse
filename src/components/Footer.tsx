    ...
    <footer className="bg-gray-100 pt-12 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-xl mb-4 text-pet-blue">Сытый<span className="text-pet-orange">зверь</span></h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li>Адрес: г. Ставрополь, ул. Серова, д. 138</li>
              <li>Телефон: +7 (495) 123-45-67</li>
              <li>Email: sitiy-zver@mail.ru</li>
        ...
        <div className="border-t border-gray-200 mt-10 pt-6 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} Сытый зверь. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
